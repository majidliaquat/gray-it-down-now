  ...
  const handleDownload = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setTimeout(() => {
        ...
        setVideoData({
          downloadUrl: '#',
          thumbnail: 'https://placehold.co/600x400/0077b5/ffffff?text=LinkedIn+Video',
  ...
  return (
    <div className="space-y-6">
      <div className="bg-blue-50 p-4 rounded-lg text-blue-800">
        <h2 className="font-medium text-lg mb-2">Download LinkedIn Videos</h2>
        <p className="text-sm">Paste a LinkedIn video URL to download the video in high quality.</p>
      </div>
      ...
      <form onSubmit={handleDownload} className="space-y-4">
        <Input
          ...
          placeholder="https://www.linkedin.com/posts/username_title-activity-123456789"
          className="w-full"
        />
      ...
      <div className="text-sm text-muted-foreground mt-4">
        <h3 className="font-medium">How to download LinkedIn videos:</h3>
        <ol className="list-decimal list-inside space-y-1 mt-2">
          <li>Find the post containing the video you want to download</li>
