  ...
  const handleDownload = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setTimeout(() => {
        ...
        setVideoData({
          downloadUrl: '#',
          thumbnail: 'https://placehold.co/600x400/e1306c/ffffff?text=Instagram+Video',
  ...
  return (
    <div className="space-y-6">
      <div className="bg-blue-50 p-4 rounded-lg text-blue-800">
        <h2 className="font-medium text-lg mb-2">Download Instagram Videos</h2>
        <p className="text-sm">Paste an Instagram video URL to download the video in high quality.</p>
      </div>
      ...
      <div className="text-sm text-muted-foreground mt-4">
        <h3 className="font-medium">How to download Instagram videos:</h3>
